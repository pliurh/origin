...
var Annotations = map[string]string{
	...
	"[sig-network][OCPFeatureGate:RouteAdvertisements][Feature:RouteAdvertisements][apigroup:operator.openshift.io] when using openshift ovn-kubernetes [EgressIP][apigroup:user.openshift.io][apigroup:security.openshift.io] pods should have the assigned EgressIPs and EgressIPs can be deleted and recreated [apigroup:route.openshift.io]": " [Suite:openshift/conformance/parallel]",

	"[sig-network][OCPFeatureGate:RouteAdvertisements][Feature:RouteAdvertisements][apigroup:operator.openshift.io] when using openshift ovn-kubernetes [EgressIP][apigroup:user.openshift.io][apigroup:security.openshift.io] pods should keep the assigned EgressIPs when being rescheduled to another node": " [Suite:openshift/conformance/parallel]",

	"[sig-network][OCPFeatureGate:RouteAdvertisements][Feature:RouteAdvertisements][apigroup:operator.openshift.io] when using openshift ovn-kubernetes [PodNetwork] advertise a user define network to the default VRF [apigroup:user.openshift.io][apigroup:security.openshift.io] External host should be able to quay route advertised pods by the pod UDN IP": " [Suite:openshift/conformance/parallel]",

	"[sig-network][OCPFeatureGate:RouteAdvertisements][Feature:RouteAdvertisements][apigroup:operator.openshift.io] when using openshift ovn-kubernetes [PodNetwork] advertise a user define network to the default VRF [apigroup:user.openshift.io][apigroup:security.openshift.io] nodes should learn BGP routes to the user defined network": " [Suite:openshift/conformance/parallel]",

	"[sig-network][OCPFeatureGate:RouteAdvertisements][Feature:RouteAdvertisements][apigroup:operator.openshift.io] when using openshift ovn-kubernetes [PodNetwork] advertise a user define network to the default VRF [apigroup:user.openshift.io][apigroup:security.openshift.io] pods should communicate with external host via UDN without being SNATed": " [Suite:openshift/conformance/parallel]",

	"[sig-network][OCPFeatureGate:RouteAdvertisements][Feature:RouteAdvertisements][apigroup:operator.openshift.io] when using openshift ovn-kubernetes [PodNetwork] advertise the default network [apigroup:user.openshift.io][apigroup:security.openshift.io] External host should be able to quay route advertised pods by the pod IP": " [Suite:openshift/conformance/parallel]",

	"[sig-network][OCPFeatureGate:RouteAdvertisements][Feature:RouteAdvertisements][apigroup:operator.openshift.io] when using openshift ovn-kubernetes [PodNetwork] advertise the default network [apigroup:user.openshift.io][apigroup:security.openshift.io] nodes should learn BGP routes to the PodNetwork": " [Suite:openshift/conformance/parallel]",

	"[sig-network][OCPFeatureGate:RouteAdvertisements][Feature:RouteAdvertisements][apigroup:operator.openshift.io] when using openshift ovn-kubernetes [PodNetwork] advertise the default network [apigroup:user.openshift.io][apigroup:security.openshift.io] pods should communicate with external host without being SNATed": " [Suite:openshift/conformance/parallel]",
